package com.example.flywheeldemo;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			pane.setBorder(com.example.flywheeldemo.BorderFactory.INSTANCE.getBorder());
		    ...
		    reset.setBorder(com.example.flywheeldemo.BorderFactory.INSTANCE.getBorder());
